...
import com.learning.graphql_playground.sec01.lec03.dto.AgeRangeFilter;
...
public class CustomerController {
    ...
    @QueryMapping
    public Flux<Customer> customersNameContains(@Argument("name") String custoemrName){
        return customerService.customersNameContains(custoemrName);
    }
